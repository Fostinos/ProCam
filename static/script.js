...
function currentCamera(){
    $.ajax({
        ...
        datatype: "json",
        success: function(data){
            $("#enableCamera").prop( "checked", data['state'] );
            $("#enableIntruder").prop( "checked", data['intruder'] );
        },
        error: function(xhr){
            showError(xhr.status);
        },
...
function applyTelemetry(data){
    $( "#kernel-blur" ).text( data['cam']['kernel_blur']);
    $( "#mask-threshold" ).text( data['cam']['mask_threshold']);
    $( "#surface-step" ).text( data['cam']['surface_step']);
    $( "#surface-threshold" ).text( data['cam']['surface_threshold']);
    $("#duration").val(data['cam']['duration']).selectmenu('refresh');
}
